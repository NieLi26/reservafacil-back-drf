async function getCategoria(id) {
    const url = `/api/v1/booking/categoria/json/${id}/`
...
async function getCategorias(params = {}) {
    console.log(params);
    let url = `/api/v1/booking/categoria/json/?`
...
async function createCategoria(data) {
    const url = `/api/v1/booking/categoria/json/`
...
async function updateCategoria(pk, data) {
    const url = `/api/v1/booking/categoria/json/${pk}/`
...
async function deleteCategoria(pk) {
    const url = `/api/v1/booking/categoria/json/${pk}/`
    const options = {
        method: 'DELETE',
        headers: {'X-CSRFToken': csrftoken},
